...
- bibliographic notes :: these are lower-level notes on biliographic sources
  content and quotes; within org-roam we designate by adding ~#+ROAM_KEY~ ids
  that references the source citekey
